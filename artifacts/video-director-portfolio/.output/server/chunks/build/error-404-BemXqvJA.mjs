...
import { v as parseQuery, k as hasProtocol, m as joinURL, l as isScriptProtocol, y as withTrailingSlash, z as withoutTrailingSlash } from '../nitro/nitro.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-0a53a3ce><div class="fixed left-0 right-0 spotlight z-10" data-v-0a53a3ce></div><div class="max-w-520px text-center z-20" data-v-0a53a3ce><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-0a53a3ce>${ssrInterpolate(__props.status)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-0a53a3ce>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-0a53a3ce>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@3.21.11_@oxc-project+types@0.143.0_@types+node@25.9.6_@vue+compiler-sfc@3.5.42_cac_4f26f11735b7eb396a77781c72e0d607/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0a53a3ce"]]);

export { error404 as default };
//# sourceMappingURL=error-404-BemXqvJA.mjs.map
