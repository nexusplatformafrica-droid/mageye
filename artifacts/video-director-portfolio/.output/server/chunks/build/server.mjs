...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="${ssrRenderClass([{ "is-active": cursorActive.value }, "cursor-play hidden md:grid"])}" style="${ssrRenderStyle({ left: `${cursorX.value}px`, top: `${cursorY.value}px` })}" aria-hidden="true"><svg viewBox="0 0 24 24" width="17" height="17" fill="currentColor" stroke="currentColor" stroke-width="1.5"><path d="m9 6 8 6-8 6V6Z"></path></svg></div><header class="nav-glass fixed inset-x-0 top-0 z-40 border-b border-[var(--line)]"><div class="mx-auto flex h-[74px] max-w-[1380px] items-center justify-between px-6 md:px-10"><a href="#top" class="group flex items-center gap-3" data-testid="link-home"><span class="grid h-8 w-8 place-items-center rounded-full bg-[var(--ink)] text-[12px] font-semibold tracking-[-.08em] text-[var(--paper)]">AK</span><span class="font-mono-ui text-[11px] uppercase tracking-[.14em]">Amara Kato</span></a><nav class="hidden items-center gap-9 md:flex" aria-label="Main navigation"><!--[-->`);
      ssrRenderList([["Work", "#work"], ["About", "#about"], ["Approach", "#approach"], ["Contact", "#contact"]], ([label, href]) => {
        _push(`<a${ssrRenderAttr("href", href)} class="font-mono-ui text-[10px] uppercase tracking-[.15em] text-[var(--ink)]/65 transition-colors hover:text-[var(--coral)]"${ssrRenderAttr("data-testid", `link-nav-${label.toLowerCase()}`)}>${ssrInterpolate(label)}</a>`);
      });
      _push(`<!--]--></nav><a href="mailto:studio@amarakato.com" class="hidden items-center gap-2 font-mono-ui text-[10px] uppercase tracking-[.14em] text-[var(--coral)] md:flex" data-testid="link-email-header"> Start a conversation <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M5 19 19 5M8 5h11v11"></path></svg></a><button type="button" class="grid h-10 w-10 place-items-center rounded-full border border-[var(--line)] md:hidden"${ssrRenderAttr("aria-label", menuOpen.value ? "Close menu" : "Open menu")}${ssrRenderAttr("aria-expanded", menuOpen.value)} data-testid="button-mobile-menu">`);
      if (menuOpen.value) {
      ...
      _push(`</header><main id="top"><section class="relative min-h-[800px] overflow-hidden px-6 pb-14 pt-[145px] md:min-h-[860px] md:px-10 md:pt-[174px]" aria-labelledby="hero-heading"><div class="mx-auto grid max-w-[1380px] grid-cols-12 gap-x-4"><div class="col-span-12 md:col-span-8"><p class="reveal font-mono-ui text-[10px] uppercase tracking-[.18em] text-[var(--coral)]">Independent director · Nairobi / East Africa</p><h1 id="hero-heading" class="reveal reveal-delay-1 mt-7 max-w-[920px] font-display text-[clamp(3.65rem,9.2vw,9.1rem)] leading-[.9] tracking-[-.065em]">Stories with<br><em>room to breathe.</em></h1><div class="reveal reveal-delay-2 mt-10 flex max-w-[560px] items-start gap-5 md:ml-[17%]"><span class="mt-2 h-px w-10 shrink-0 bg-[var(--coral)]"></span><p class="max-w-[420px] text-[15px] leading-[1.65] text-[var(--ink)]/70">Amara Kato is a film director and visual storyteller making intimate documentaries and atmospheric brand films about the people, places and quiet forces shaping our future.</p></div></div><div class="reveal reveal-delay-3 col-span-12 mt-14 md:col-span-7 md:col-start-6 md:mt-[-20px]"><div class="group relative overflow-hidden rounded-[28px] bg-[#c5b493]"><img${ssrRenderAttr("src", asset("/images/hero-dawn.jpg"))} alt="A woman standing among tall grass at dawn in the Ngong Hills" class="film-image aspect-[1.45] w-full object-cover md:aspect-[1.5]"><div class="absolute inset-0 bg-gradient-to-t from-[rgba(25,61,58,.32)] to-transparent"></div><span class="absolute bottom-5 left-5 font-mono-ui text-[9px] uppercase tracking-[.15em] text-[var(--paper)]">Field note 01 · Ngong Hills</span><span class="absolute right-5 top-5 grid h-11 w-11 place-items-center rounded-full border border-[rgba(241,234,220,.65)] text-[var(--paper)]"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 4v16M6 14l6 6 6-6"></path></svg></span></div></div></div><div class="mx-auto mt-12 flex max-w-[1380px] items-center justify-between border-t border-[var(--line)] pt-4"><span class="font-mono-ui text-[9px] uppercase tracking-[.15em] text-[var(--ink)]/55">Scroll to explore</span><span class="font-mono-ui text-[9px] uppercase tracking-[.15em] text-[var(--ink)]/55">01 — 07</span></div></section><section id="work" class="bg-[var(--ink)] px-6 py-24 text-[var(--paper)] md:px-10 md:py-36" aria-labelledby="work-heading"><div class="mx-auto max-w-[1380px]"><div class="reveal flex flex-col justify-between gap-8 md:flex-row md:items-end"><div><p class="font-mono-ui text-[10px] uppercase tracking-[.18em] text-[var(--coral)]">Selected work</p><h2 id="work-heading" class="mt-5 max-w-[700px] font-display text-[clamp(3rem,6.4vw,6.7rem)] leading-[.92] tracking-[-.06em]">People before polish.</h2></div><p class="max-w-[240px] text-sm leading-[1.65] text-[var(--paper)]/60">Films that stay close to the gesture, the pause, the unscripted turn.</p></div><div class="mt-16 grid gap-14 md:grid-cols-12 md:gap-x-6 md:gap-y-24"><!--[-->`);
      ssrRenderList(films, (film, index) => {
        _push(`<article class="${ssrRenderClass([index === 1 ? "reveal-delay-1 md:col-start-4" : "", "film-card reveal md:col-span-9"])}"><button type="button" class="group block w-full text-left"${ssrRenderAttr("data-testid", `button-play-${film.id}`)}><div class="relative overflow-hidden rounded-[26px]" style="${ssrRenderStyle({ backgroundColor: film.color })}"><img${ssrRenderAttr("src", film.image)}${ssrRenderAttr("alt", `${film.title} film still`)} class="film-image aspect-[1.55] w-full object-cover"><div class="absolute inset-0 bg-[rgba(25,61,58,.06)] transition-colors group-hover:bg-[rgba(25,61,58,.18)]"></div><span class="absolute right-5 top-5 flex items-center gap-2 rounded-full bg-[var(--paper)] px-3 py-2 font-mono-ui text-[9px] uppercase tracking-[.12em] text-[var(--ink)] opacity-0 transition-opacity group-hover:opacity-100"> Watch film <svg viewBox="0 0 24 24" width="11" height="11" fill="currentColor" stroke="currentColor" stroke-width="1"><path d="m9 6 8 6-8 6V6Z"></path></svg></span></div><div class="mt-5 flex flex-col gap-3 border-b border-[rgba(241,234,220,.24)] pb-6 md:flex-row md:items-start md:justify-between"><div><h3 class="font-display text-3xl italic tracking-[-.03em]">${ssrInterpolate(film.title)}</h3><p class="mt-2 text-xs text-[var(--paper)]/60">${ssrInterpolate(film.description)}</p></div><div class="flex shrink-0 items-center gap-4 font-mono-ui text-[9px] uppercase tracking-[.12em] text-[var(--paper)]/55"><span>${ssrInterpolate(film.type)}</span><span>${ssrInterpolate(film.year)}</span><span>${ssrInterpolate(film.runtime)}</span></div></div></button></article>`);
      });
      _push(`<!--]--></div><div class="reveal mt-20 flex items-center justify-between border-t border-[rgba(241,234,220,.24)] pt-5"><span class="font-mono-ui text-[9px] uppercase tracking-[.15em] text-[var(--paper)]/50">More stories in the edit</span><a href="mailto:studio@amarakato.com?subject=Amara%20Kato%20work%20request" class="group flex items-center gap-2 font-mono-ui text-[10px] uppercase tracking-[.14em] text-[var(--coral)]" data-testid="link-request-reel"> Request full reel <svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="1.5" class="transition-transform group-hover:translate-x-1 group-hover:-translate-y-1"><path d="M5 19 19 5M8 5h11v11"></path></svg></a></div></div></section><section id="about" class="px-6 py-24 md:px-10 md:py-40" aria-labelledby="about-heading"><div class="mx-auto grid max-w-[1380px] gap-14 md:grid-cols-12 md:gap-6"><div class="reveal md:col-span-3"><p class="font-mono-ui text-[10px] uppercase tracking-[.18em] text-[var(--coral)]">A director&#39;s note</p><p class="mt-10 max-w-[170px] font-mono-ui text-[9px] uppercase leading-[1.7] tracking-[.12em] text-[var(--ink)]/50">On attention / on trust / on the long take</p></div><div class="reveal reveal-delay-1 md:col-span-8 md:col-start-5"><h2 id="about-heading" class="font-display text-[clamp(2.7rem,5.5vw,5.8rem)] leading-[.98] tracking-[-.055em]">I make films for the moment <em class="text-[var(--coral)]">before</em> someone realises the camera is there.</h2><div class="mt-11 grid gap-8 text-[15px] leading-[1.7] text-[var(--ink)]/70 md:grid-cols-2"><p>My work begins with listening. I am interested in the in-between: a hand hovering over a workbench, a laugh that arrives late, the particular hush of a place just before it wakes.</p><p>From Nairobi, I work across East Africa and wherever a good story asks me to go. The aim is simple: make something honest enough to keep looking at.</p></div><a href="#contact" class="mt-10 inline-flex items-center gap-2 border-b border-[var(--coral)] pb-2 font-mono-ui text-[10px] uppercase tracking-[.13em] text-[var(--coral)]" data-testid="link-about-contact">Bring me into the room <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M5 19 19 5M8 5h11v11"></path></svg></a></div></div></section><section class="border-y border-[var(--line)] bg-[var(--paper-deep)] px-6 py-20 md:px-10 md:py-28" aria-labelledby="services-heading"><div class="mx-auto grid max-w-[1380px] gap-14 md:grid-cols-12 md:gap-6"><div class="reveal md:col-span-4"><p class="font-mono-ui text-[10px] uppercase tracking-[.18em] text-[var(--coral)]">Ways of working</p><h2 id="services-heading" class="mt-5 font-display text-4xl leading-none tracking-[-.04em]">The right size<br><em>for the story.</em></h2></div><div class="md:col-span-7 md:col-start-6"><!--[-->`);
